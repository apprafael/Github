...
class RepositoriesRouter: NSObject, RepositoriesRoutingLogic, RepositoriesDataPassing
{
  ...
  //func navigateToSomewhere(source: RepositoriesViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: RepositoriesDataStore, destination: inout SomewhereDataStore)
  //{
